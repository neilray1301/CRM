                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 form-group pull-right" style="text-align: right; margin-top: 5%">
                                    ...
                                    <asp:LinkButton ID="btnDelete" runat="server" TabIndex="17" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    </div>
