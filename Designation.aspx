<%@ Page Title="" Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="Designation.aspx.cs" Inherits="Designation" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtName" CssClass ="form-control" TabIndex="1" runat="server" placeholder="Enter Designation"></asp:TextBox>
