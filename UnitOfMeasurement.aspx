<%@ Page Title="" Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="UnitOfMeasurement.aspx.cs" Inherits="UnitOfMeasurement" %>
                   ...
                   <div class="col-md-6">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h4>Unit of Measurement Details</h4>
                        </div>
                        <div class="box-body">
                            <asp:GridView ID="grddata" runat="server" AlternatingRowStyle-BackColor="#C2D69B" AllowPaging="false" AllowSorting="false"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblname" runat="server" Text='<%# Eval("UnitofMeasurement") %>'></asp:Label>
                                        </ItemTemplate>
