...
public partial class OrderEntry : System.Web.UI.Page
{
    ...
    protected void btnaddproduct_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                DateTime localTime = TimeZoneInfo.ConvertTimeFromUtc(utcTime, tzi);
                //  txtrate.Text = "2000";
                bal.tbl_Order_Details_InsertBAL(Convert.ToInt32(lblqno.Text), Convert.ToInt32(dpitem.SelectedValue.ToString()), Convert.ToInt32(dpuom.SelectedValue.ToString()), Convert.ToDecimal(txtqty.Text), Convert.ToDecimal(txtrate.Text), Convert.ToDecimal(txtamount.Text), lblloginid.Text, localTime, "", "", "", "", "");
                resetcontact();
                binditemdata();
    ...
    protected void lbtnupdatecontact_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            bal.tbl_Order_Details_updateDAL(Convert.ToInt32(lblid.Text), Convert.ToInt32(dpitem.SelectedValue.ToString()), Convert.ToInt32(dpuom.SelectedValue.ToString()), Convert.ToDecimal(txtqty.Text), Convert.ToDecimal(txtrate.Text), Convert.ToDecimal(txtamount.Text), lblloginid.Text, localTime, "", "", "", "", "");
            resetcontact();
            binditemdata();
    ...
    protected void lbtnaddfollowup_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                bal.tbl_Order_Followup_InsertBAL(Convert.ToInt32(lblqno.Text), txtfdate.Text, Convert.ToInt32(dpfollowuptype.SelectedValue.ToString()), 0, Convert.ToInt32(dpfollowstatus.SelectedValue.ToString()), txtfremarks.Text, "", "", lblloginid.Text, localTime, "", "", "", "", "");
                resetfollowup();
                bindfollowupdata();
                //txtcontactname.Focus();
            }
